          ...
          <form onSubmit={handleLogin} className="space-y-4">
            ...
            <div className="space-y-1.5">
              ...
              <input
                ...
                className={`w-full bg-white/80 border ${errors.server ? 'border-red-500' : 'border-slate-200'} rounded-xl py-2.5 px-4 text-sm focus:outline-none focus:ring-2 focus:ring-blue-500/10 focus:border-blue-500 transition-all text-slate-700 placeholder:text-slate-300`}
                required
              />
            </div>
            ...
            {errors.server && (
              <p className="text-red-500 text-xs ml-1 bg-red-50 p-2 rounded-lg border border-red-200">
                {errors.server}
              </p>
            )}
