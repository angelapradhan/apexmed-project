...
const createHospital = async (req, res) => {
    try {
        // 1. Files haru check garne (Multer middleware le req.files ma rakhchha)
        ...
        // 4. Postgres ma save garne (Sequelize)
        const newHospital = await Hospital.create({
            ...
            emergency247, 
            icuAvailable,
            hospitalLogo, // File name save hunchha
            coverImage    // File name save hunchha
        });
...
module.exports = { createHospital, getAllHospitals, getSingleHospital };